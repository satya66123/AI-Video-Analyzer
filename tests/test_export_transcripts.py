...
class TestExportTranscripts:
    ...
    @patch("components.export_transcripts.TranscriptUtils.list_transcripts")
    ...
    @patch("components.export_transcripts.TranscriptUtils.read_transcript")
    @patch("components.export_transcripts.TranscriptUtils.list_transcripts")
    @patch("components.export_transcripts.st.download_button")
    def test_show_export_transcripts_success(
        ...
        assert kwargs["label"] == "📦 Download All Transcripts"
        assert kwargs["file_name"] == "transcripts.zip"
